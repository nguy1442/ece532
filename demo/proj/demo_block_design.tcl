...
################################################################
# This is a generated script based on design: demo_block_design
#
...
# source demo_block_design_script.tcl
...
set design_name demo_block_design
...
xilinx.com:user:custom_demo_ip:2.0\
...
user.org:user:segmentsDriver:1.0\
...
proc create_root_design { parentCell } {
  ...
  set seven_seg_an [ create_bd_port -dir O -from 7 -to 0 seven_seg_an ]
  set seven_seg_ca [ create_bd_port -dir O -from 6 -to 0 seven_seg_ca ]
  set switches [ create_bd_port -dir I -from 15 -to 0 switches ]
  ...
  # Create instance: Custom_IP_ILA, and set properties
  set Custom_IP_ILA [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 Custom_IP_ILA ]

  # Create instance: Ethernet_IP_ILA, and set properties
  set Ethernet_IP_ILA [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 Ethernet_IP_ILA ]

  # Create instance: Switches_ILA, and set properties
  set Switches_ILA [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 Switches_ILA ]
  set_property -dict [ list \
  ...
  # Create instance: custom_demo_ip_0, and set properties
  set custom_demo_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:custom_demo_ip:2.0 custom_demo_ip_0 ]
  ...
  # Create instance: segmentsDriver_0, and set properties
  set segmentsDriver_0 [ create_bd_cell -type ip -vlnv user.org:user:segmentsDriver:1.0 segmentsDriver_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins custom_demo_ip_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets microblaze_0_axi_periph_M02_AXI] [get_bd_intf_pins Custom_IP_ILA/SLOT_0_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets microblaze_0_axi_periph_M05_AXI] [get_bd_intf_pins Ethernet_IP_ILA/SLOT_0_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI] [get_bd_intf_pins segmentsDriver_0/S00_AXI]
  ...
  connect_bd_net -net btnl_1 [get_bd_ports btnl] [get_bd_pins custom_demo_ip_0/btnl]
  connect_bd_net -net btnr_1 [get_bd_ports btnr] [get_bd_pins axi_gpio_0/gpio_io_i]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins Custom_IP_ILA/clk] [get_bd_pins Ethernet_IP_ILA/clk] [get_bd_pins Switches_ILA/clk] [get_bd_pins axi_ethernetlite_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins custom_demo_ip_0/s00_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk] [get_bd_pins segmentsDriver_0/s00_axi_aclk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_ethernetlite_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins custom_demo_ip_0/s00_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins segmentsDriver_0/s00_axi_aresetn]
  ...
  connect_bd_net -net segmentsDriver_0_anode [get_bd_ports seven_seg_an] [get_bd_pins segmentsDriver_0/anode]
  connect_bd_net -net segmentsDriver_0_cathode [get_bd_ports seven_seg_ca] [get_bd_pins segmentsDriver_0/cathode]
  connect_bd_net -net switches_1 [get_bd_ports switches] [get_bd_pins Switches_ILA/probe0] [get_bd_pins custom_demo_ip_0/switches]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs custom_demo_ip_0/S00_AXI/S00_AXI_reg] SEG_custom_demo_ip_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs custom_demo_ip_0/S00_AXI/S00_AXI_reg] SEG_custom_demo_ip_0_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs segmentsDriver_0/S00_AXI/S00_AXI_reg] SEG_segmentsDriver_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs segmentsDriver_0/S00_AXI/S00_AXI_reg] SEG_segmentsDriver_0_S00_AXI_reg
